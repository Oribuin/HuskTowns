...
import net.william278.husktowns.data.message.pluginmessage.PluginMessage;
import net.william278.husktowns.data.message.redis.RedisMessage;
            ...
            default -> {
                ...
                switch (message.getMessageType()) {
                    ...
                    case GET_PLAYER_LIST -> {
                        ...
                        getMessage(Message.MessageType.RETURN_PLAYER_LIST, playerList.toString()).sendToServer(recipient, requestingServer);
                    }
